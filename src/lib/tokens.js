...
const THEME_DEFS = {
  warmCream: {
    ...
    accent: '#9A7830', accentLight: '#AE8C3C', accentDim: 'rgba(154,120,48,0.10)', accentGlow: 'rgba(154,120,48,0.06)', accentText: '#FFFFFF',
  ...
  pureLight: {
    ...
    accent: '#2660B0', accentLight: '#3474C8', accentDim: 'rgba(38,96,176,0.10)', accentGlow: 'rgba(38,96,176,0.06)', accentText: '#FFFFFF',
  ...
  sage: {
    ...
    accent: '#277A56', accentLight: '#348C65', accentDim: 'rgba(39,122,86,0.10)', accentGlow: 'rgba(39,122,86,0.06)', accentText: '#FFFFFF',
  ...
  midnight: {
    ...
    accent: '#C8A96E', accentLight: '#D4BA7E', accentDim: 'rgba(200,169,110,0.14)', accentGlow: 'rgba(200,169,110,0.08)', accentText: '#1A1400',
  ...
  ocean: {
    ...
    accent: '#0B8A9C', accentLight: '#1AA0B2', accentDim: 'rgba(11,138,156,0.10)', accentGlow: 'rgba(11,138,156,0.06)', accentText: '#FFFFFF',
  ...
  indigo: {
    ...
    accent: '#5B5BD6', accentLight: '#6E6EE6', accentDim: 'rgba(91,91,214,0.10)', accentGlow: 'rgba(91,91,214,0.08)', accentText: '#FFFFFF',
    green: '#1A7A50', greenDim: 'rgba(26,122,80,0.10)',
